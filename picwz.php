...
include_once('include/base.php');
    ...
    //$w = "心建议";
    //$w = mb_convert_encoding($w, "html-entities", "utf-8");
    imagettftext($image,12,0,10,10,$textcolor,$font,$w);
    ...
    for($i=1;$i<=$count;$i++){
        ...
        imagettftext($image,9,$xz,$x,$y,$textcolor,$font,$pot);
    }
